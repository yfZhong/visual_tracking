...
inline void yuv2rgb(int yuvimg[], unsigned char rgbbuffer[], int W, int H){
...
// 		rgbbuffer[i] =   saturateValue( yuvimg[i]+1.772f  *(yuvimg[i+1]-128) );
	  	rgbbuffer[i] = saturateValue( yuvimg[i]+1.402f  *(yuvimg[i+2]-128) );
		rgbbuffer[i+1] = saturateValue( yuvimg[i]-0.34414f*(yuvimg[i+1]-128)-0.71414f*(yuvimg[i+2]-128) );
		rgbbuffer[i+2] =   saturateValue( yuvimg[i]+1.772f  *(yuvimg[i+1]-128) );
	}
