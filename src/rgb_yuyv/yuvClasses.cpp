...
bool YUVColorLUT::ReadYUVLookUpTable(const string inputName){
	...
	std::string absName = ros::package::getPath("vision_6d_pose") + "/" + inputName;
...
// void vision::yuvImageSubsampling(unsigned char classificationBuffer[], vector <YUVColorClass> & objects, unsigned char mask[]){
// 
